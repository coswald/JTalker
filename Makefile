...
docs: source
	@mkdir -p docs
	@echo "Making docs..."
	@$(JD) -sourcepath $(SRCDIR) -d $(DOCDIR) -use -splitIndex -windowtitle $(WTITLE) -doctitle $(DTITLE) -header $(HEADER) -bottom $(BOTTOM) -linkoffline https://docs.oracle.com/javase/10/docs/api/ https://docs.oracle.com/javase/10/docs/api/ -html5 -author -version @sources
	@echo "Adding favicon..."
